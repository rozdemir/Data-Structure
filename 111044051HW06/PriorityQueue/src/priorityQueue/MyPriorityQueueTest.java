...
public class MyPriorityQueueTest{
	 ...
	 * 
	 */
	private MyPriorityQueue<Integer> myQueue;
	
	public MyPriorityQueueTest() {
		// TODO Auto-generated constructor stub
		this.myQueue = new MyPriorityQueue<Integer>() ;
	}
	
	public MyPriorityQueue<Integer> factory()
	{
		return new MyPriorityQueue<Integer>() ;
	...
	public void toArrayTest4(){
		...
		this.myQueue.add(new Integer(4));
		this.myQueue.add(new Integer(3));
		assertEquals(6, this.myQueue.toArray()[2]);
